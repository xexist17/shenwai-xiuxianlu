...
## 🛒 最終下單版（2026-08-07 定稿）— 照這張買，零思考

每一項都已定案，含缺貨／漲價時的替換規則。你不需要再做任何決定，照表執行即可。

| # | 品項（照這個字串在估價單搜尋） | 目標價 | 上限價 | 超標或缺貨就換 |
|---|---|---:|---:|---|
| 1 | AMD Ryzen 7 7700（盒裝） | 7,190 | 7,500 | Ryzen 7 7700X |
| 2 | 華碩 TUF GAMING B850M-PLUS WIFI | 6,300 | 6,800 | 華擎 B850M Pro RS WiFi（約 5,300） |
| 3 | 金士頓 FURY Beast DDR5-6000 32GB(16G×2) CL30 | 11,400 | 12,700 | Acer HT200／UMAX／XPG Lancer 同規挑最便宜 |
| 4 | 微星 RTX 5070 Ti 16G VENTUS 3X OC | 33,000 | **36,000** | 技嘉 WINDFORCE／華碩 PRIME 挑最便宜；**全部破上限 → 改 RTX 5060 Ti 16G（上限 21,000），其餘品項不動（850W 留給未來換卡）** |
| 5 | WD 黑標 SN850X 2TB（無散熱片版） | 8,500 | 9,500 | Kioxia Exceria Plus G4／美光 T500／金士頓 KC3000 2TB |
| 6 | 微星 MAG A850GL PCIE5（850W 金牌 ATX3.1） | 3,000 | 3,500 | 海韻 FOCUS GX-850 ATX3.1／Corsair RM850e |
| 7 | Montech AIR 903 MAX（黑） | 2,000 | 2,400 | Fractal Pop Air／聯力 LANCOOL 207 |
| 8 | 利民 Phantom Spirit 120 EVO | 1,200 | 1,400 | 利民 Peerless Assassin 120 SE（約 900） |
| 9 | CyberPower CP800AVR UPS（估價單沒有就上 PChome 買） | 2,500 | 2,900 | 任一 650–800VA 在線互動式 UPS |

### 總價紅綠燈（含 UPS）

- **≤ 78,000** → 🟢 直接結帳
- **78,000–82,000** → 🟡 找出超標的那項，照右欄換掉再結
- **> 82,000、或顯卡全面破 36,000** → 🔴 GPU 降為 5060 Ti 16G 版（總價約 62,000），或隔幾天再看價

### 下單三步驟

1. 開 [原價屋線上估價](https://www.coolpc.com.tw/evaluate.php)，照上表逐項在對應分類點選（CPU→主機板→記憶體→SSD→顯卡→電源→機殼→散熱）。
2. 產生估價單 → 走線上訂購，選宅配或門市自取。不方便原價屋就到[欣亞](https://www.sinya.com.tw)照同一張單組，一樣有代組服務。
3. 訂單備註欄整段貼上：

```
代客組裝＋燒機測試。CPU 散熱請裝清單內的利民塔散（不裝原廠風扇）。
記憶體插 A2/B2 雙通道。SSD 裝 CPU 直連的第一個 M.2 插槽。
機殼風扇接主機板 PWM，其餘設定預設即可。
```

**加購（非必要，可之後再補）**：Windows 11 Pro 隨機版約 5,300–5,800（也可先不啟用裝著用，之後再買授權）。螢幕、鍵盤、滑鼠未含在內。
...
### 橫置（平放）變體：機殼換銀欣 FLP01

想平放（電視櫃／層架／螢幕壓上面）就把機殼換成 **SilverStone FLP01**（約 2,790，復古橫式 27L）或便宜版 GD09-C，並連動改兩項：
- 散熱器改 **利民 AXP120-X67 下吹式**（限高 138mm，塔散放不下；7700 65W 壓起來綽綽有餘）
- 顯卡限長 309mm → 5070 Ti 只能挑短版：**技嘉 WINDFORCE SFF（30.4cm）** 或華碩 PRIME；5060 Ti 不受限
- 加購一顆 120mm 風扇補進氣（原廠只附一顆）
- ⚠️ 24/7 重載散熱天花板比直立塔低；**放密閉櫃是烤箱，務必開放層板或留通風**
